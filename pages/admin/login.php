...
if (isset($_SESSION['rentrover-id'])) {
...
<body>
    <section class="container position-absolute rounded login-container">
        ...
        <form action="/rentrover/pages/admin/app/app-login.php" method="POST"
            class="container form p-0 mt-3 d-flex flex-column" id="login-form">
            <!-- csrf token -->
            ...
            <!-- login btn -->
            <button type="submit" class="btn btn-brand" id="login-btn"> Login </button>

            <div class="d-flex flex-column gap-3 flex-md-row justify-content-between mt-2 bottom">
                <p class="m-0 small">
                    Donot have an account? <a href="/rentrover/admin/registration" class="text-primary"> Register Now
                    </a>
                </p>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#login-form').submit(function (e) {
                e.preventDefault();
                $.ajax({
                    url: '/rentrover/pages/admin/app/app-login.php',
                    data: $(this).serialize(),
                    type: "POST",
                    beforeSend: function () {
                    ...
                    success: function (response) {
                        if (response == "true") {
                            ...
                            setTimeout(function () {
                                ...
                                window.location.href = "/rentrover/admin/dashboard";
                            }, 2000);
                        } else {
