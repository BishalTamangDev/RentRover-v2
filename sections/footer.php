<footer class="bg-dark text-light mt-5">
    <div class="container d-flex flex-row flex-wrap w-100 gap-2 py-4 footer-container">
        ...
        <div class="contact footer-section">
            ...
            <ul>
                <li> <i class="fa-solid fa-angles-right"></i> <span> 9823645014 </span> </li>
                <li> <i class="fa-solid fa-angles-right"></i> <span> rentrover.info@gmail.com </span> </li>
            </ul>
        </div>
    </div>
</footer>
...
<!-- copyright -->
<div class="py-2 section bg-brand text-light d-flex flex-row justify-content-around copyright">
